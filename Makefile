...
.PHONY: train
train: ## 階段 C: 執行 LoRA 微調 (small + base 兩輪)
	$(RUN_APP) scripts/run_training.py
...
.PHONY: retrieve
retrieve: ## 階段 D: 執行混合檢索示範
	$(RUN_APP) scripts/run_retrieval.py
...
.PHONY: gpu-status
gpu-status: ## 查看 GPU 使用狀態 (需在宿主機執行)
	nvidia-smi
